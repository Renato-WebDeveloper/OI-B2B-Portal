        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <div class="container-fluid">
              <div class="row">
                <div class="col-md-12">
                  <form enctype="multipart/form-data" action="save-csv-report-r1.php" method="POST" name="input_file">
                    <strong>Enviar Report Mensal - R1:</strong><br/>
            ...
            <div class="container-fluid">
              <div class="row">
                <div class="col-md-12">
                  <form enctype="multipart/form-data" action="save-csv-report-r2.php" method="POST" name="input_file">
                    <strong>Enviar Report Mensal - R2:</strong><br/>
                    <input class="form-control-file" name="userfile" type="file" id="upload_csv_report"/>
                    <input type="submit" value="Enviar arquivo" class="btn btn-primary"/>
                  </form>
                </div>
