...
$directory = '/var/www/html/OI-B2B-Portal/uploads/plan/';
...
if (file_exists($file_directory)) {
	...
	if($csv->insertPlanIntoTheDb($file_directory)) {
		$message = ("Olá Grande mestre! O resumo do mês acaba de ser atualizado e encontra-se no diretório padrão ");
		$bot->sendMessage($message);
		?><script type="text/javascript">window.location.href="upload-csv-report.php";</script><?php
	} else {
